...
class Form_Builder
{
  ...
  function __set($name, $value)
  {
    ...
    { 
      ...
      case 'dict':
        ...
        break;
      case 'r_only':
        $this->form_data['r_only'] = array_merge($this->form_data['r_only'], $value);
        break;
      default:
  ...
  // Returns fields that need to check as unique
  public function get_unique()
  {
    if (!empty($this->form_data['unique'])) return $this->form_data['unique'];
  }
  
  // Return table id
  public function get_id_field()
  {
    if (!empty($this->form_data['type']))
      foreach($this->form_data['type'] as $field_name=>$field_type)
        if ($field_type == 'id') return $field_name;
  }
  ...
  public function get_data_array($provided_data = null)
  {
    ...
    {
      // Used for data, provided by standard sql requests (non flx)
