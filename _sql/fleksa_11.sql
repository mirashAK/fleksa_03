...
--
-- Хост: localhost
-- Час створення: Лип 03 2013 р., 12:28
...
CREATE PROCEDURE `get_columns_defs`(IN in_table_name varchar(40), IN in_read_level INT, IN in_write_level INT, OUT out_columns varchar(255), OUT out_defs varchar(512))
BEGIN
...
CREATE PROCEDURE `get_table`(IN in_user_token VARCHAR(40), IN in_ip VARCHAR(15), IN in_table_name varchar(40), IN in_where varchar(100), IN in_order varchar(100), IN in_limit varchar(30))
    READS SQL DATA
BEGIN
	DECLARE var_query VARCHAR(255);
...
(43, 'public_users', 'u_name', 'edit', 'Name', 0, 50),
(44, 'public_users', 'u_soname', 'email', 'Soname', 0, 50),
...
(298, 0, '0e4f30a591c5ba0e77c160cf54f85a82', '127.0.0.1', 'J6lJwfNZLrzexhbdS1JwmXOKWYGbNVcBlAaRSvrHD/a/XAvuyQsR2D5uiz615BS2PH0o6eW7h4zc8wvOJkvbfg', '2013-07-03 08:27:37');
...
(1, '0:05:0.0', '2013-07-03 08:26:49', '0:01:0.0', 'ababagalamaga');
...
(14, '', '12dsd@s.com', '763259646ecb5234653b19809bacc972', 1, 2, '2013-06-19 11:09:23');
