...
--
-- Хост: localhost
-- Час створення: Лип 17 2013 р., 20:12
...
BEGIN
	...
	DECLARE result_cursor CURSOR FOR 
		SELECT `field_name`,`field_type`,`field_href`,`field_require`,`field_caption`,`field_write_level` FROM `syst_defs_columns` 
	...
	FETCH result_cursor INTO var_column, var_def, var_href, var_req, var_caption, var_w_level;
	...
	WHILE var_is_end != true DO
		...
		SET out_defs = CONCAT
		(out_defs,'"',var_column,'":{"type":"',var_def,'","caption":"',var_caption,'","r_only":',var_ro_ind,',"require":',var_req,'},');
...
BEGIN
    ...
    ELSE /* If user is valid */
		...
		/* Main result query */
		SET @query = CONCAT("SELECT ", var_selected_columns, ",IF((",var_user_write_lvl," > `write_level` OR `owner`=",var_active_user_id,"), 'false', 'true') AS `r_only` FROM `", in_table_name, "`", var_conditions);
		-- SELECT @query;
		PREPARE var_query FROM @query;
		EXECUTE var_query;
		DEALLOCATE PREPARE var_query; 
...
BEGIN
    ...
    ELSE /* If user is valid */
		...
		WHILE var_is_end != true DO
			...
			SET var_value = '';
			/* Get Fields values */
			SET var_start = LOCATE(CONCAT('\\"',var_name,'\\":'), in_values, var_start) + LENGTH(CONCAT('\\"',var_name,'\\":'));
...
(1, 0, 'link', 'One', NULL, NULL, NULL, 0, 0, 0),
(2, 0, 'link', '<a href="link;">(link)</a>', NULL, NULL, NULL, 0, 0, 0),
(3, 0, 'new_link', '<a href="link;">(link)</a>', NULL, NULL, NULL, 40, 41, 0),
(4, 0, 'link', '/^(([^<>()[].,;:s@"]+(.[^<>()[].,;:s@"]+)*)|(".+"))@(([[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}])', NULL, NULL, NULL, 0, 0, 0),
(5, 0, 'link', '/^(([^<>()[].,;:s@"]+(.[^<>()[].,;:s@"]+)*)|(".+"))@(([[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}])', NULL, NULL, NULL, 0, 0, 0),
(6, 0, 'link', '/^(([^<>()[].,;:s@', NULL, NULL, NULL, 0, 0, 0),
(7, 0, 'link', 'wewewewe', NULL, NULL, NULL, 0, 0, 0),
(8, 0, ': ', 'wewewewe', NULL, NULL, NULL, 0, 50, 0),
(9, 0, ': ', 'wewewewe', NULL, NULL, NULL, 0, 0, 0),
(10, 0, ':', 'wewewewe', NULL, NULL, NULL, 0, 0, 0),
(23, 19, 'Евгений308', 'evgen@u.com', NULL, NULL, NULL, 10, 91, 19),
(19, 13, 'Евгений', 'evgen@u.com', NULL, NULL, NULL, 40, 41, 13);
...
INSERT INTO `syst_defs_columns` (`def_id`, `table_name`, `field_name`, `field_type`, `field_href`, `field_require`, `field_caption`, `field_read_level`, `field_write_level`, `field_order`) VALUES
(52, 'public_users', 'u_gender', 'select', 'dict_genders', 0, 'Gender', 0, 20, 6),
(3, 'public_main_menu', 'menu_item_name', 'edit', NULL, 0, 'menu_item_name', 0, 50, 0),
(4, 'public_main_menu', 'menu_item_link', 'edit', NULL, 0, 'menu_item_link', 0, 50, 0),
(5, 'public_main_menu', 'owner', 'id', NULL, 0, 'owner', 80, 50, 0),
(6, 'public_static_pages', 'static_page_id', 'id', NULL, 0, 'id', 20, 50, 0),
(7, 'public_static_pages', 'static_page_alias', 'edit', NULL, 0, 'alias', 0, 50, 0),
(8, 'public_static_pages', 'static_page_text', 'text', NULL, 0, 'text', 0, 50, 0),
(10, 'public_categories', 'cat_id', 'id', NULL, 0, 'id', 0, 80, 0),
(11, 'public_categories', 'cat_name', 'edit', NULL, 0, 'name', 0, 80, 0),
(12, 'public_categories', 'cat_alias', 'edit', NULL, 0, 'alias', 0, 80, 0),
(13, 'public_categories', 'cat_parent_id', 'id', NULL, 0, 'parent_id', 0, 80, 0),
(14, 'public_articles', 'article_id', 'id', NULL, 0, 'id', 0, 50, 0),
(15, 'public_articles', 'article_name', 'edit', NULL, 0, 'name', 0, 50, 0),
(16, 'public_articles', 'article_alias', 'edit', NULL, 0, 'alias', 0, 50, 0),
(17, 'public_articles', 'article_text', 'edit', NULL, 0, 'text', 0, 50, 0),
(18, 'hrefs_articles_to_categories', 'href_cat_id', 'id', NULL, 0, 'cat_id', 0, 50, 0),
(19, 'hrefs_articles_to_categories', 'href_article_id', 'id', NULL, 0, 'article_id', 0, 50, 0),
(42, 'public_users', 'u_id', 'id', NULL, 0, 'id', 0, 90, 1),
(43, 'public_users', 'u_name', 'edit', NULL, 0, 'Name', 0, 40, 3),
(44, 'public_users', 'u_soname', 'email', NULL, 0, 'Soname', 0, 40, 4),
(45, 'public_users', 'u_settings', 'json', NULL, 0, 'Settings', 0, 50, 5),
(46, 'public_users', 'u_f_user_id', 'id', NULL, 0, 'user_id', 0, 40, 2),
(53, 'public_users', 'u_timeset', 'multi', 'dict_timesets', 0, 'Timezones', 0, 20, 7);
...
(366, 0, 'd13f70d7874fbb66560b7618be2a1d78', '127.0.0.1', 'J5hhV87WczlpdTxGGJjpstaJXM6q0tXGIeRBippMZXdheZTDYE19QciX8VMXa3GY30GFbB9+hqeQocnSQoG5Bw', '2013-07-17 16:11:37');
...
(1, '2:15:0.0', '2013-07-17 14:50:48', '1:05:0.0', 'ababagalamaga');
...
(19, '', 'evgen308@i.ua', '763259646ecb5234653b19809bacc972', 1, 2, '2013-07-12 10:00:00');
